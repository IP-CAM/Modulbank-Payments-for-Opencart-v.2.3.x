...
class ControllerExtensionPaymentModulbank extends Controller
{
	...
	public function index()
	{
		...
		$data['text_log_link']      = $this->url->link('extension/payment/modulbank/logs', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/modulbank', 'token=' . $this->session->data['token'], true),
		);

		$data['action'] = $this->url->link('extension/payment/modulbank', 'token=' . $this->session->data['token'], true);
